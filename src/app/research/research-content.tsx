        ...
        <div className="grid lg:grid-cols-2 gap-12 mt-12 items-start">
          ...
          <div className="grid grid-cols-1 gap-6">
            <ProductCard
              ...
              image="https://placehold.co/600x400/1e3a8a/ffffff?text=GEM-C30+HPGe+Detector"
            ...
            <ProductCard
              ...
              image="https://placehold.co/600x400/1e3a8a/ffffff?text=GammaVision+Software"
        ...
        <div className="grid lg:grid-cols-2 gap-12 mt-12 items-start">
          <div className="grid grid-cols-1 gap-6 order-2 lg:order-1">
            <ProductCard
              ...
              image="https://placehold.co/600x400/1e3a8a/ffffff?text=MOBIUS-ST-DET"
