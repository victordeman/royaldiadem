      ...
      <Section>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="space-y-6">
            ...
            <h1 className="text-5xl font-bold text-slate-900 dark:text-white capitalize">{params.id.replace(/-/g, ' ')}</h1>
          </div>
          ...
          <div className="aspect-video rounded-3xl overflow-hidden glass-premium border border-white/10">
             <div className="w-full h-full bg-slate-50 dark:bg-slate-900/50 flex items-center justify-center">
                <span className="text-slate-900 dark:text-white/20 italic">Project imagery coming soon</span>
             </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
             <div className="p-8 glass-premium rounded-2xl border border-white/5 text-center">
                ...
                <div className="text-slate-900 dark:text-white text-xl">14 Months</div>
             </div>
             <div className="p-8 glass-premium rounded-2xl border border-white/5 text-center">
                <div className="text-gold font-bold mb-2 uppercase tracking-widest text-xs">Standard</div>
                <div className="text-slate-900 dark:text-white text-xl">AS9100D</div>
             </div>
             <div className="p-8 glass-premium rounded-2xl border border-white/5 text-center">
                <div className="text-gold font-bold mb-2 uppercase tracking-widest text-xs">Complexity</div>
                <div className="text-slate-900 dark:text-white text-xl">High</div>
             </div>
          </div>

          <article className="prose prose-invert max-w-none space-y-8 text-slate-900 dark:text-white/70 text-lg leading-relaxed">
             ...
             <h2 className="text-3xl font-bold text-slate-900 dark:text-white">Technical Challenges</h2>
             <p>
             ...
             <div className="p-12 glass-premium rounded-[2rem] border border-gold/20 my-16">
                ...
                <p className="text-slate-900 dark:text-white text-xl leading-relaxed italic">
